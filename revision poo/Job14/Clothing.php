...
class Clothing extends AbstractProduct implements StockableInterface
{
    ...
    // Constructeur
    public function __construct(int|null $id = 0, string $name = "", array $product_photo = [], int $price = 0, string $description = "", int $quantity = 0, int $category_id = 0, DateTime $createdAt = new DateTime(), DateTime $updatedAt = new DateTime(), string $size = "", string $color = "", string $type = "", int $material_fee = 0)
    {
